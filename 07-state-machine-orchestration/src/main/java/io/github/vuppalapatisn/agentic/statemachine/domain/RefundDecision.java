...
/** The model's classification — one node inside an otherwise deterministic machine. */
...
public record RefundDecision(
        ...
        @JsonPropertyDescription("Proposed refund amount in minor units. Must equal the order total for a full refund; use 0 otherwise.")
